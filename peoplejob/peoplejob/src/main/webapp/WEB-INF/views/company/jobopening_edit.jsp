    ...
    <div class="col-md-9">
        ...
        <input type="text" name="companyCode" value="${vo.companyCode}">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input id="workdate" name="workdate" class="form-control" type="text" value="${vo.workdate }"/>
                </div>
            </div>
            ...
            <div class="form-group">
                <div class="col-sm-offset-2 col-sm-10">
                    ...
                    <input id="end_date" name="endDate" class="form-control" type="text" value="${vo.endDate }"/>
                </div>
            </div>
            <!-- 
             <div class="form-group">
