...
<body>
	...
	<div class="divForm">
		...
		<div class="center">
			<a href="<c:url value='/resume/edit.do?no=${param.resumeCode}'/>">수정</a> |
        	<a href="<c:url value='/resume/delete.do?no=${param.resumeCode}'/>">삭제</a> |
        	<a href="<c:url value='/resume/list.do'/>">목록</a>			
		</div>
	</div>
