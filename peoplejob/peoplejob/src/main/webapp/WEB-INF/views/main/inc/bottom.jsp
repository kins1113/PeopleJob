...
<footer>
		...
		<div class="bg11">
			<div class="container size-h-4 flex-c-c p-tb-15">
				<span class="f1-s-1 cl0 txt-center">
					<a href="#" class="bottomanchor">회사소개</a>
					<a href="#" class="bottomanchor">광고문의</a>
					<a href="#" class="bottomanchor">공지사항</a>
					<a href="#" class="bottomanchor">이용약관</a>
				</span>
				<div>
				</div>
			</div>
		...
		<div class="bg11">
			<div class="container size-h-4 flex-c-c p-tb-15">
			<span class="f1-s-1 cl0 txt-center">
			주소 : 서울시 서초구 서초대로 00빌딩 13층~14층 | 대표: 김옥환 | Email : peoplejob@peoplejob.co.kr
			</span>
			</div>
		</div>
		...
		<div class="bg11">
			<div class="container size-h-4 flex-c-c p-tb-15">
				...
				Copyright 2019 All rights reserved | This site is made with  by PEOPLEJOB
				</span>
			</div>
		</div>
	</footer>
