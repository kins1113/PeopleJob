          ...
          <div id="sidebar" class="sidebar sidebar-with-footer">
            ...
            <div class="sidebar-scrollbar">
              ...
              <ul class="nav sidebar-inner" id="sidebar-menu">
                  ...
                  <li  class="has-sub" >
                    ...
                    <ul  class="collapse"  id="pages"
                      ...
                      <div class="sub-menu">
                            ...
                            <li >
                              <a class="sidenav-item-link" href="notice">
                ...
                <li  class="has-sub" >
                    <a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse" data-target="#Manager"
                      aria-expanded="false" aria-controls="Manager">
                      <i class="mdi mdi-chart-pie"></i>
                      <span class="nav-text">Manager</span> <b class="caret"></b>
                    </a>
                    <ul  class="collapse"  id="Manager"
                      data-parent="#sidebar-menu">
                      <div class="sub-menu">
                            ...
                            <li >
                              <a class="sidenav-item-link" href="<c:url value='/manager/manger/managerList.do'/>">
                                <span class="nav-text">조회</span>
                              </a>
                            </li>
                          	<li >
                              <a class="sidenav-item-link" href="#">
                                <span class="nav-text">권한 보기</span>
                              </a>
                            </li>
